  ...
  return (
    <div className=" gap-10 flex-vertical-center h-full px-5 text-center">
      ...
      <div className="flex-vertical-center gap-4 w-full">
        <Link href={"/auth/create"} className="w-full flex justify-center">
        ...
        <div className="separator relative flex items-center justify-center max-w-[480px] w-full my-4">
          ...
          <span className=" text-neutral-400 absolute p-1 bg-[#f7f7f7]">
            OR
          </span>
        </div>
        <div className="cta bg-white text-neutral-500 border border-neutral-500 rounded-2xl py-4 px-6 max-w-[480px] w-full hover:scale-101 transition-transform duration-200 cursor-pointer flex items-center justify-center gap-3">
      ...
      <Link
        href="/signup"
        className="text-primary-purple-2 py-4 px-6 max-w-[480px] w-full cursor-pointer hover:underline font-semibold mt-10"
      >
        Sign up later
      </Link>
    </div>
