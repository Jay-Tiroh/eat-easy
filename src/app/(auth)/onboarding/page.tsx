    ...
    <>
      ...
      <div className=" gap-10 hidden lg:flex-vertical-center h-full px-5 text-center">
        <div className="flex-vertical-center gap-4 max-w-[480px]">
          <h1 className="font-heading font-medium text-[40px] tracking-[-0.5px] leading-12 dark:text-white">
            Let’s Get Started 😁
          </h1>{" "}
      ...
      {/* mobile screen */}
      <div className="dark-bg lg:hidden flex-vertical-center h-full text-center py-10">
        <AuthIllustration />
        <div className="flex-vertical-center gap-4 w-full pt-8">
          <Link
            href="/signup"
            className="text-primary-purple-2 dark:text-primary-purple-5 py-4 px-6 max-w-[327px] lg:max-w-[480px] w-full cursor-pointer hover:underline"
          >
            Sign up later
          </Link>
          <Link href={"/auth"} className="w-full flex justify-center">
